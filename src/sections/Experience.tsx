        ...
        <div className="mt-12 max-w-3xl mx-auto">
          {xp.map((job, idx) => (
            <motion.div
              ...
              className="p-6 md:p-8 rounded-2xl bg-[#020617] border border-slate-800 hover:border-sky-500/20 transition-all duration-300"
            >
              {/* Cargo */}
              <div className="mb-6">
              ...
              <div>
                ...
                <ul className="space-y-3 font-resolve text-slate-300 text-sm md:text-base list-disc list-inside pl-1">
                  {job.highlights.map((item, index) => (
                    <li key={index} className="leading-relaxed text-slate-400">
