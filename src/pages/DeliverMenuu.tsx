...
import About from "../sections/deliver-menuu/About";
import Pictures from "../sections/deliver-menuu/Pictures";
import Stack from "../sections/deliver-menuu/Stack";

export default function DeliverMenuu() {
  return (
